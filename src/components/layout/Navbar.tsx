...
function Navbar() {
  ...
  const CONTACT_PHONE = '540074405';
  const CONTACT_EMAIL = 'support@crystelio.com';

  return (
    <>
      {/* Top Info Bar — Warm Beige */}
      <div className="hidden lg:block h-9 bg-[#d9a890]">
        <div className="container mx-auto px-4 h-full flex items-center justify-center">
          <p className="text-white text-sm md:text-base font-medium tracking-wide text-center">
            توصيل سريع ومجاني لجميع أنحاء المملكة
          </p>
        </div>
      </div>
        ...
        <div className="bg-white shadow-sm border-b border-gray-100">
          <div className="container mx-auto px-3 sm:px-4">
              ...
              <div className="flex items-center justify-self-end space-x-2 rtl:space-x-reverse">
                ...
                <div className="relative" ref={cartDropdownRef}>
                  ...
                  >
                    ...
                    {cartItemsCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-[#c18c78] text-white border-2 border-white rounded-full min-w-[16px] h-[16px] flex items-center justify-center text-[9px] font-bold">
                        {cartItemsCount}
                      </span>
                    )}
                  </button>
            ...
            <div className="hidden md:flex items-center justify-between h-16 sm:h-20">
              {/* 🔵 LEFT GROUP: Search, Lang, Wishlist, Cart */}
              ...
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <a
                  ...
                  className="flex items-center text-gray-700 hover:text-[#10B981] font-medium text-sm"
                >
                  <Phone size={14} className="ml-1.5 rtl:mr-1.5 flex-shrink-0" />
                  <span className="hidden xs:inline">{CONTACT_PHONE}</span>
                </a>
                <a
                  href={`mailto:${CONTACT_EMAIL}`}
                  className="flex items-center text-gray-700 hover:text-[#10B981] font-medium text-sm"
                >
                  <Mail size={14} className="ml-1.5 rtl:mr-1.5 flex-shrink-0" />
                  <span className="hidden xs:inline">{CONTACT_EMAIL}</span>
                </a>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-5">
              ...
              {user ? (
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <div className="flex items-center space-x-3 rtl:space-x-reverse mb-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#d9a890] to-[#c18c78] flex items-center justify-center text-black font-bold text-sm">
                  ...
                  <div className="flex flex-col space-y-2">
                    <Link
                      to="/profile"
                      onClick={() => setIsMenuOpen(false)}
                      className="text-sm text-gray-700 hover:text-[#c18c78] font-medium py-1.5 px-2 rounded flex items-center"
                    >
                ...
                <button
                  onClick={openAuthModal}
                  className="w-full bg-[#d9a890] hover:bg-[#c18c78] text-black py-3 rounded-xl font-semibold transition-colors shadow-sm"
                >
                  {t('nav.login')}
                </button>
              )}
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <Link
                      ...
                      to={link.href}
                      onClick={() => setIsMenuOpen(false)}
                      className="flex flex-col items-center justify-center px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-800 shadow-sm hover:shadow-md hover:border-[#c18c78]/40 hover:bg-[#d9a890]/10 transition-all"
                    >
                      <link.icon size={22} className="mb-1 text-[#d9a890]" />
              ...
              <div className="pt-2">
                ...
                >
                  ...
                  {wishlistItemsCount > 0 && (
                    <span className="bg-[#c18c78] text-white text-xs font-bold px-2 py-0.5 rounded-full min-w-[20px] text-center">
                      {wishlistItemsCount}
                    </span>
                  )}
                </Link>
