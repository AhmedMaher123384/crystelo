...
const CategoryCollectionBar: React.FC<Props> = ({ variant = 'default' }) => {
  ...
  if (variant === 'navbar') {
    return (
      <div
        dir={isRTL ? 'rtl' : 'ltr'}
        className="w-full bg-white text-gray-800 border-t border-[#c18c78]/20 border-b border-gray-100 shadow-sm"
      >
          ...
          {[
                  ...
                  {hasSubs && openCategoryId === cat.id && (
                    ...
                    >
                      <div className="px-3 py-2 text-gray-600 text-xs font-medium flex items-center gap-2 bg-gray-50/50 rounded-xl mb-1.5">
                        <ListTree className="w-3.5 h-3.5 text-[#d9a890]" />
                        ...
                        {subByParent[cat.id].map((sub) => (
                          <button
                            ...
                            className={`
                              ...
                              hover:bg-[#d9a890]/10 hover:text-gray-900
                            `}
                          >
            ...
            return (
              ...
              >
                ...
                {col.featured && (
                  <span className="text-[11px] font-semibold px-2 py-0.5 rounded-lg bg-[#d9a890]/15 text-[#c18c78]">
                    {t('featured') || 'Featured'}
                  </span>
                )}
              </button>
