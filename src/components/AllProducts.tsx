...
const AllProducts: React.FC = () => {
 ...
 className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#c18c78] focus:border-[#c18c78] text-gray-800"
                />
              </div>
            </div>
 ...
 className="w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#c18c78] focus:border-[#c18c78] text-gray-800 bg-white"
              >
 ...
 className={`p-2 rounded-md ${viewMode === 'grid' ? 'text-[#c18c78] bg-[#d9a890]/10' : 'text-gray-600 hover:text-gray-900'}`}
 ...
 className={`p-2 rounded-md ${viewMode === 'list' ? 'text-[#c18c78] bg-[#d9a890]/10' : 'text-gray-600 hover:text-gray-900'}`}
 ...
 className="flex items-center gap-2 text-sm text-[#c18c78] font-medium hover:text-[#c18c78]"
              >
                <X className="w-4 h-4" />
 ...
 <Package className="w-6 h-6 text-[#c18c78]" />
            </div>
            ...
            {(searchTerm || selectedCategory !== null) && (
              <button
                onClick={clearFilters}
 className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#d9a890] text-white font-medium rounded-md hover:bg-[#c18c78]"
              >
                <X className="w-4 h-4" />
