...
const LanguageCurrencySelector: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      {/* 🌟 الزر الجديد: أبيض نقي، نص #d9a890، أنيق جدًّا */}
      <button
      ...
      >
        ...
        {/* رمز العملة — لون #d9a890 */}
        <span className="font-medium text-[#d9a890] text-sm">
          {getCurrentCurrencySymbol()}
        </span>

        {/* سهم — لون #d9a890، يدور عند الفتح */}
        <ChevronDown 
          className={`
            w-4 h-4 transition-transform duration-300
            ${isOpen ? 'rotate-180 text-[#d9a890]' : 'text-[#d9a890]/70'}
          `} 
        />
      </button>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="px-4 py-3 bg-[#fdf9f7] border-b border-[#d9a890]/10">
            <h3 className="text-[#d9a890] font-medium text-sm flex items-center gap-2">
          ...
          <div className="max-h-60 overflow-y-auto">
            {/* اللغات */}
            <div className="p-2">
              <div className="px-2 py-1.5 text-[#d9a890]/80 text-xs font-medium flex items-center gap-2 mb-1.5">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${currentLanguage.code === lang.code
                      ? `bg-[#fdf9f7] text-[#d9a890] font-medium border border-[${PRIMARY_COLOR}]/20`
            ...
            {/* فاصل رفيع — لون #d9a890/10 */}
            <div className="px-4 py-0.5">
              <div className="h-px bg-[#d9a890]/10"></div>
            </div>
            ...
            <div className="p-2">
              ...
              {currencies.map((currency) => (
                <button
                  ...
                  `}
                >
                  <div className="flex items-center justify-center w-8 h-8 rounded-xl bg-[#d9a890]/10 text-[#d9a890] font-bold text-sm">
