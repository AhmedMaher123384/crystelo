...
const CollectionPage: React.FC = () => {
 ...
 className="w-full px-3 py-2 text-gray-800 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-[#c18c78] focus:border-[#c18c78]"
          >
        ...
        {sortedProducts.length > 0 ? (
          ...
          <div className="text-center py-16 px-4 bg-gray-50 rounded-lg">
            ...
            <Link
              to="/"
              className="inline-flex items-center justify-center px-5 py-2.5 bg-[#d9a890] text-white font-medium rounded-md hover:bg-[#c18c78]"
            >
              {t('back_to_home')}
            </Link>
          </div>
