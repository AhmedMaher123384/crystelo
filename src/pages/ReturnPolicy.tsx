...
const ReturnPolicy: React.FC = () => {
 ...
 <div className="absolute inset-0 bg-gradient-to-br from-[#d9a890]/25 to-[#c18c78]/20 rounded-xl border border-[#c18c78]/30" />
              <div className="absolute inset-0 flex items-center justify-center">
 <Shield className="w-6 h-6 sm:w-8 sm:h-8 text-[#c18c78]" />
              </div>
            </div>
 ...
 <div className="bg-white rounded-xl border border-[#c18c78]/20 p-3 max-w-xs sm:max-w-md mx-auto animate-slideInRight">
            <div className="flex items-center gap-2 justify-center">
 <Calendar className="w-4 h-4 text-[#c18c78]" />
 ...
 <div className="bg-white rounded-2xl border border-[#c18c78]/15 shadow-xl p-4 sm:p-6 lg:p-8">
            {sections.map((section, sIdx) => (
              <div key={sIdx} className="mb-6 sm:mb-8">
 <h2 className="text-xl sm:text-2xl font-bold text-[#c18c78] mb-4 flex items-center gap-2">
 <FileText className="w-5 h-5 text-[#c18c78]" />
                  {section.heading}
                </h2>
                <div className="space-y-3">
                  {section.items.map((item, iIdx) => (
                    <div
                      key={iIdx}
 className="flex items-start gap-2 bg-[#d9a890]/5 p-3 rounded-lg border border-[#c18c78]/10 hover:bg-[#d9a890]/10 transition-colors"
                    >
 <CheckCircle className="w-4 h-4 text-[#c18c78] mt-0.5 flex-shrink-0" />
